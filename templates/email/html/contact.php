                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td> <a href="<?= $this->Url->build(['controller' => 'ContactUs', 'action' => 'view]'], ['fullBase' => true]);?>" target="_blank">Call To Action</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Copyright <?php echo date("Y") ?> Iconic Prints. All rights reserved. </span>
