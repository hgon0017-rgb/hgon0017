...
<!--    .progress-fill{ height:100%; background:#4f46e5; width:--><?php //= $progressPct ?>/*%; transition:width .3s; }*/
...
/*        <h4>Admin</h4>*/
/*        <ul class="nav-list">*/
/*            <li><a class="nav-link active" href="*/<?php //= $incomeUrl ?><!--">💰 Income</a></li>-->
<!--            <li><a class="nav-link" href="--><?php //= $productsUrl ?><!--">🛒 Products</a></li>-->
<!--            <li><a class="nav-link" href="--><?php //= $usersUrl ?><!--">👥 Users</a></li>-->
<!--        </ul>-->
<!--    </aside>-->
<!---->
    <!-- Right content -->
...
<!--                <div class="stat-card">-->
<!--                    <h3>$--><?php //= number_format($totalIncome, 2) ?><!--</h3>-->
<!--                    <p>Total Income</p>-->
<!--                </div>-->
<!--                <div class="stat-card">-->
<!--                    <h3>$--><?php //= number_format($thisMonth, 2) ?><!--</h3>-->
<!--                    <p>This Month</p>-->
<!--                </div>-->
<!--                <div class="stat-card">-->
<!--                    <h3>--><?php //= number_format($orderCount) ?><!--</h3>-->
<!--                    <p>Orders</p>-->
<!--                </div>-->
<!--                <div class="stat-card">-->
<!--                    <h3>--><?php //= number_format($newCustomers) ?><!--</h3>-->
<!--                    <p>New Customers</p>-->
<!--                </div>-->
<!--            </div>-->
<!---->
...
<!--                <p class="muted">Spend $--><?php //= number_format($targetSales) ?><!-- to earn a $10 coupon</p>-->
<!--                <div class="progress-bar">-->
<!--                    <div class="progress-fill"></div>-->
<!--                </div>-->
<!--                <p class="muted" style="margin-top:6px;">-->
<!--                    Progress: $--><?php //= number_format($currentSales, 2) ?><!-- / $--><?php //= number_format($targetSales, 2) ?><!-- (--><?php //= $progressPct ?><!--%)-->
<!--                </p>-->
<!--            </div>-->
<!--        </div>-->
<!--    </main>-->
